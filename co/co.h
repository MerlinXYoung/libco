...
void co_eventloop(co_epoll_t *ctx, co_eventloop_fn pfn UTHREAD_CPP(= NULL),
                  void *arg UTHREAD_CPP(= NULL));
...
FORCE_INLINE void co_eventloop_ct(co_eventloop_fn pfn UTHREAD_CPP(= NULL),
                                  void *arg UTHREAD_CPP(= NULL)) {
